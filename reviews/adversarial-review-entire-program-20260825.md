...
- Target: the complete tracked GitRail program at `/Users/johncoppedge/Projects/grove/repos/herdr-gitrail`, including runtime code, plugin manifest, configuration, tests, scripts, and active documentation.
